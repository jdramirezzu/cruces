...
def vista_aportes(engine):
    ...
    return aportes_por_cc

def vista_movimientos(engine):
...
def movimientos_cedula():
    ...
    return movimientos_cedula


def numero_prestamos():
    ...
    return prestamos_conf

def objeto_to_numero():
...
def_merge_tablas():
    ...
    vista_aportes(engine)
    vista_movimientos(engine)
    vista_prestamos(engine)
